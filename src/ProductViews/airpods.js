...
export default function Airpods(){
  ...
  const airpodsProducts = (groupedProducts['airpods'] || []).filter((product) => !product.isSold);
  ...
  return (
    ...
    <div
      ...
      <div className="category-container">
        <h1 className="category-title">Airpods</h1>
        {airpodsProducts && airpodsProducts.map((product, index) => (
          <div
