...
export default function Applewatch(){
  ...
  const applewatchProducts = (groupedProducts['applewatch'] || []).filter((product) => !product.isSold);
  ...
  return (
    ...
    <div
      ...
      <div className="category-container">
        <h1 className="category-title">Apple watch</h1>
        {applewatchProducts && applewatchProducts.map((product, index) => (
          <div
