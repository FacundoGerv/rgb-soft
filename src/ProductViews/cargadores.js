...
export default function Energy() {
  ...
  const energyProducts = (groupedProducts['energy'] || []).filter((product) => !product.isSold);
  ...
  return (
    ...
    <div
      ...
      <div className="category-container">
        <h1 className="category-title">Cargadores</h1>
        {energyProducts && energyProducts.map((product, index) => (
          <div
